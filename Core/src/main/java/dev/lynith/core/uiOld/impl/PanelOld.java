 ...
 */
public class PanelOld extends Component implements ChildrenFeature {
    ...
    public PanelOld(Direction direction) {
    ...
    public static PanelOld of(Component... components) {
        return of(Direction.COLUMN, components);
    }

    public static PanelOld of(Direction direction, Component... components) {
        PanelOld panel = new PanelOld(direction);
